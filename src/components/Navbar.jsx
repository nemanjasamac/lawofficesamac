...
function Navbar() {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-1 lg:space-x-2">
            ...
            <NavLink to="/istorija">O nama</NavLink>
            <NavLink to="/oblasti">Oblasti prava</NavLink>
            <NavLink to="/tim">Naš tim</NavLink>
            <NavLink to="/kontakt">Kontakt</NavLink>
            <Link to="/kontakt" className="ml-4 px-5 py-2 bg-accent hover:bg-accent-hover text-bg-secondary font-medium rounded transition-all duration-300 shadow-lg hover:shadow-accent/20">
              Konsultacije
            </Link>
          </div>
      ...
      <div className={`md:hidden transform transition-all duration-300 ease-in-out ${isOpen
          ? 'opacity-100 max-h-96'
          : 'opacity-0 max-h-0 pointer-events-none'
        } overflow-hidden`}>
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t border-bg-light">
          <MobileNavLink to="/">Početna</MobileNavLink>
          <MobileNavLink to="/o-nama">O nama</MobileNavLink>
          <MobileNavLink to="/oblasti-prava">Oblasti prava</MobileNavLink>
          <MobileNavLink to="/nas-tim">Naš tim</MobileNavLink>
          <MobileNavLink to="/kontakt">Kontakt</MobileNavLink>
          <div className="pt-4 pb-2">
            <Link to="/kontakt" className="block w-full text-center px-4 py-2 bg-accent hover:bg-accent-hover text-bg-secondary font-medium rounded-md transition-all duration-300">
